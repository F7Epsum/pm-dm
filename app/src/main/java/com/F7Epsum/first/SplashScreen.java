...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView splashAppName = findViewById(R.id.splasAppName);
        splashLogo.startAnimation(gradientColor);
        ...
        Glide.with(this)
                .load("https://images.unsplash.com/photo-1728410994982-e376651ba722?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
